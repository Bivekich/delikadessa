...
function Contact() {
  return (
    <div className="bg-cover bg-center overflow-hidden mx-auto px-4" style={{ backgroundImage: `url(${contact})` }}>
      <div className="container mx-auto p-4">
        <div className="mt-16">
          <h1 className="text-center text-4xl text-[#722082] mb-8" 
          style={{ 
            fontFamily:'Kornilow', 
            fontSize: '40px', 
            fontWeight: 400, 
          ...
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <div className="text-center">
              <h2 className="text-2xl text-[#ffffff] mb-2" 
                style={{ 
                fontFamily: 'Inter', 
                fontSize: '32px', 
                fontWeight: 600, 
